...
##########################################
# Parameter dictionary setup with updated conductances from CSV
params = {
    'K_out': K_out, 'K_in': K_in, 'Ca_out': Ca_out, 'Ca_in': Ca_in,
    'Na_out': Na_out, 'Na_in': Na_in, 'Cl_out': Cl_out, 'Cl_in': Cl_in,
    
    # Scale channel conductances with RNA data and updated unitary conductances:
    'conductance_Kir6.1': 37.5e-12 * scaling_Kir,  # Using 37.5 pS from CSV (35-40 pS range)
    'base_conductance_TRPC3': 80e-12,  # Using 80 pS from CSV
    'scaling_TRPC3': scaling_TRPC3,
    'conductance_CaL': 25e-12 * scaling_CaL,  # Using 25 pS from CSV
    'base_conductance_CaCC': 8e-12,  # Using 8 pS from CSV
    'scaling_CaCC': scaling_CaCC,
    'conductance_IP3R1': 80e-12 * scaling_IP3R1,  # Using 80 pS from CSV (70-90 pS range)
    'conductance_RyR': 0.01,  # Keeping original as not in CSV
    'conductance_Nav1.2': 15e-12 * scaling_Nav,  # Using 15 pS from CSV

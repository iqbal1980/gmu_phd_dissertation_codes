...
##########################################
# De Young-Keizer IP3R parameters (in mM, ms^-1)
a1 = 400.0
a2 = 0.2
a3 = 400.0
a4 = 0.2
...
# Other parameters for Phase 2 (should be similar to phase 1, but if Phase 2 introduced changes, they should be consistent)
...
def calculate_pmca_flux(Ca_i,dpmca,params):
    ...
    # Convert ions/s to mM/ms by dividing by 6.6253e5
    u4 = u4/(6.6253e5)
    u5 = u5/(6.6253e5)
...
def plot_results_with_two_figures(sol,params):
    ...
    fig1.suptitle('Cell Dynamics - Part 1 (Phase 2)', fontsize=16, fontweight='bold')
    ...
    fig2.suptitle('Cell Dynamics - Part 2 (Phase 2)', fontsize=16, fontweight='bold')

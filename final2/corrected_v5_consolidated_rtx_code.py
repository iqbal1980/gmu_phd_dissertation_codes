...
def calculate_currents(V, Ca_i, atp, dpmca, params):
    ...
    tau_d = params['activation_slope_CaL'] / (1 + np.exp((V - params['activation_midpoint_CaL']) / params['activation_slope_CaL']))  # Example time constant for d_inf
    ...
    tau_f = params['inactivation_slope_CaL'] / (1 + np.exp((V - params['inactivation_midpoint_CaL']) / params['inactivation_slope_CaL']))  # Example time constant for f_inf

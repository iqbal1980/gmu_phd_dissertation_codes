...
def model(t, y, params):
    ...
    # Debugging prints (remove or comment out after verification)
    print(f"Time: {t:.2f}, V: {V:.2f}, Ca_i: {Ca_i:.6f}, I_CaL: {I_CaL:.4f}, I_PMCA: {I_PMCA:.4f}")
...
def main():
    ...
    calcium_extrusion_rate = st.sidebar.text_input("Ca2+ Extrusion Rate (ms^-1)", value="1.0")  # Increased from 0.1 to 1.0

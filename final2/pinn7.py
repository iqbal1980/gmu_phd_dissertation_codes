...
def train_pinn(pinn, x_train, y_train, num_epochs, learning_rate):
...
pinn = train_pinn(pinn, x_train, y_train, num_epochs, learning_rate)

# Test the trained PINN
test_input = torch.tensor([[20.008702984240095, Ibg_init_val, 0.9, 11.0, 1, 4.502039575569403, -70]])

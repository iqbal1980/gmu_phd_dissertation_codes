...
This script:
  ...
  3) Then, it does a simple param-sweep example: varying the CaL conductance
     by a few factors to see if that breaks or modifies the "mirror" shape.

The goal is to illustrate how to debug or systematically investigate
why the model might show symmetrical responses. Feel free to edit
the “Param Sweep” or “Steady-State Finder” sections to investigate
further or to focus on specific parameters of interest.
...
if __name__=="__main__":
    ...
    plot_multicell(sol1, p, label_suffix="(I_app=+70)")
    ...
    plot_multicell(sol_ss_plus, p, label_suffix="(SteadyState init, +70)")

    # also see mirror
    p['I_app_val']   = -70.0
    sol_ss_minus= run_multicell_sim(p, initial_Y=Yss)
    plot_multicell(sol_ss_minus, p, label_suffix="(SteadyState init, -70)")
    ...
    for factor in [0.5, 1.0, 2.0]:
        ...
        plot_multicell(sol_sweep, p,
                       label_suffix=f"(CaL x{factor}, I_app=+70)")

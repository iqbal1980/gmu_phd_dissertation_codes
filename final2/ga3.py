...
def main():
    ...
    if pop is None:
        ...
        pop = toolbox.population(n=10000)  # Adjust the population size if needed
    else:
    ...
    for gen in range(100):  # Specify the number of generations
        ...
        for ind in invalid_ind:
            ...
            eval_counter += 1  # Increment the evaluation counter

            # Checkpointing after every 50 evaluations
            if eval_counter % 50 == 0:
                print(f"Checkpointing after {eval_counter} evaluations.")
